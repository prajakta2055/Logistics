import {
  ...
  function Shipments() {
    ...
    return (
      ...
      <Navbar 
                  tab={"Shipments"}
              />
    <div className="text-gray-600 body-font section" style={{ width: '50%', marginRight: 'auto' }}>
  ...
  <div className='flex'>
    <Flex
      ...
      w='50%'
    >
      {/* ... (Rest of your code for the right-hand side section) */}
      <Box position='absolute' left='52%' top='21%' h='50%' w='95%'>
      {/* Google Map Box */}
      <GoogleMap
        center={center}
        zoom={10}
    ...
    <Box
      ...
      shadow='base'
      minW='container.md'
      zIndex='1'position='absolute' left='50%' top='11%' h='8%' w='50%'
    >
